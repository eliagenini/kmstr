...
CREATE TABLE IF NOT EXISTS kmstr.fuel_status
(
    id            serial  NOT NULL,
    vehicle       integer NOT NULL,
    level         integer NOT NULL,
    last_captured date    NOT NULL DEFAULT CURRENT_DATE
);
...
(
    ...
    last_capured date    NOT NULL DEFAULT CURRENT_DATE
);

ALTER TABLE ONLY kmstr.vehicles ADD CONSTRAINT vehicles_pk PRIMARY KEY (id);
ALTER TABLE ONLY kmstr.fuel_type ADD CONSTRAINT fuel_type_pk PRIMARY KEY (id);
ALTER TABLE ONLY kmstr.fuel_status
    ADD CONSTRAINT fuel_status_pk PRIMARY KEY (id),
    ADD CONSTRAINT fuel_status_fk_vehicle FOREIGN KEY (vehicle) REFERENCES kmstr.vehicles(id);
...
INSERT INTO kmstr.fuel_type (id, type) VALUES (1, 'Gasoline');
INSERT INTO kmstr.fuel_type (id, type) VALUES (2, 'Diesel');
INSERT INTO kmstr.fuel_type (id, type) VALUES (3, 'Other');
